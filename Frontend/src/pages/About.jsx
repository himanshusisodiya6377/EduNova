...
const About = () => {
  return (
    ...
    {/* heading+subheading */}
    <p className='text-4xl font-semibold w-[70%] text-center mt-16'>
    ...
    {/* img */}
    <div className='flex top-40  lg:flex-row flex-col gap-4 mt-16'>
    ...
    <div className='w-11/12 mx-auto'>
        <p id="para1" className='font-semibold lg:text-4xl  text-center pb-10 text-white mt-40'>We are passionate about revolutionizing the way we learn. Our innovative platform <TextGrad text={"combines technology"}/>, <TextGrad text={"expertise"}/>, and <br/> community to create an <TextGrad text={"unparalleled educational experience."}/></p>
    </div>
    </section>
    <section className='w-11/12 mx-auto'>
      <div className='flex flex-row w-full mt-20 pb-32 gap-4'>
         ...
         <img className='h-[90%]' src={img4}/>
        </div>
        <div className='flex  flex-row gap-6 pb-28 mt-4 w-full'>
